...
tar -xvf $cur/amazon.tar.xz --exclude='dev'||:
...
printf "\x1b[38;5;214m[${time1}]\e[0m \x1b[38;5;83m[Installer thread/INFO]:\e[0m \x1b[38;5;87m The installation has been completed! You can now launch Amazon with ./startamazon.sh\n"
printf "\e[0m"
